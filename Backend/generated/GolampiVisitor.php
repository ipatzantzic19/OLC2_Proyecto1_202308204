...
interface GolampiVisitor extends ParseTreeVisitor
{
	...
	/**
	 * Visit a parse tree produced by {@see GolampiParser::caseExpressionList()}.
	 *
	 * @param Context\CaseExpressionListContext $context The parse tree.
	 *
	 * @return mixed The visitor result.
	 */
	public function visitCaseExpressionList(Context\CaseExpressionListContext $context);

	/**
	 * Visit a parse tree produced by the `RangeCaseExpr` labeled alternative
	 * in {@see GolampiParser::caseExpression()}.
	 *
	 * @param Context\RangeCaseExprContext $context The parse tree.
	 *
	 * @return mixed The visitor result.
	 */
	public function visitRangeCaseExpr(Context\RangeCaseExprContext $context);

	/**
	 * Visit a parse tree produced by the `SingleCaseExpr` labeled alternative
	 * in {@see GolampiParser::caseExpression()}.
	 *
	 * @param Context\SingleCaseExprContext $context The parse tree.
	 *
	 * @return mixed The visitor result.
	 */
	public function visitSingleCaseExpr(Context\SingleCaseExprContext $context);
	...
	/**
	 * Visit a parse tree produced by the `BasicType` labeled alternative
